...
int main(void)
{
	...
	{
		outputfile << YELLOW "insert (basic range)" RESET << std::endl;	
		NAMESPACE::vector<int> v(3,100);
		NAMESPACE::vector<int>::iterator it;
	...
	{
		outputfile << YELLOW "insert (range2)" RESET << std::endl;
		...
		it = v.begin() + 3;
		v.insert(it, v.begin(), v.begin() + 4);

		// 1, 1, 3, 6, 7
		//         ^
		//         1, 3, 6, 7	(the range to insert)
		// 1, 1, 3, >1, 3, 6, 7<, 6, 7
